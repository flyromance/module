define(function(require) {
  ...
  assert(id2Uri('//ajax.googleapis.com/ajax/lib/jquery/1.9.1/jquery.min.js') === location.protocol + '//ajax.googleapis.com/ajax/lib/jquery/1.9.1/jquery.min.js', 'id2Uri')
